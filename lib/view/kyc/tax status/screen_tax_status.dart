...
class _ScreenTaxStatusState extends State<ScreenTaxStatus> {
  @override
  void initState() {
    Provider.of<KycController>(context, listen: false).commingToTaxPage();
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: DropdownButton(
                            ...
                            value: kycController.taxvalue,
                            isExpanded: true,
                            underline: Container(
                              height: 0,
                            ),
                            items: kycController.taxList.map((String value) {
                ...
                onTap: () async {
                  ...
                  if (kycController.taxcode != '01') {
                    ...
                    if (result == true) {
                      ...
                      showFlushbar(
                          context, 'Our customer care contact you shortly');
                    } else {
                    ...
                    bool result = await kycController.getInn(context);
                    if (result == true) {
                      // ignore: use_build_context_synchronously
                      Navigator.of(context).pushReplacement(
                        MaterialPageRoute(
