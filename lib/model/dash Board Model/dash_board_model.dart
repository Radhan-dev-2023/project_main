...
DashBoardModel fliterModelFromJson(String str) =>
    DashBoardModel.fromJson(json.decode(str));

String fliterModelToJson(DashBoardModel data) => json.encode(data.toJson());
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        bank: Bank.fromJson(json["bank"]),
        activationStatus: ActivationStatus.fromJson(json["activationStatus"]),
        achmandate: Achmandate.fromJson(json["achmandate"]),
        id: json["_id"],
        phoneNumber: json["phoneNumber"],
        email: json["email"],
        iin: json["iin"],
